...
struct Settings {
    ...
    is_library_only_marked_enabled: bool,
    is_filter_marked_enabled: bool,
    is_only_marked_enabled: bool,
...
impl Default for Settings {
    fn default() -> Self {
        Self {
            ...
            is_library_only_marked_enabled: false,
            is_filter_marked_enabled: true,
            is_only_marked_enabled: false,
...
fn get_setting_value(settings: &Settings, key: &str) -> Value {
    ...
    match key {
        ...
        "isLibraryOnlyMarkedEnabled" => to_value(settings.is_library_only_marked_enabled),
        "isFilterMarkedEnabled" => to_value(settings.is_filter_marked_enabled),
        "isOnlyMarkedEnabled" => to_value(settings.is_only_marked_enabled),
...
fn apply_setting_value(settings: &mut Settings, key: &str, value: Value) -> Result<bool, String> {
    match key {
        ...
        "isLibraryOnlyMarkedEnabled" => set_bool(&mut settings.is_library_only_marked_enabled, value),
        "isFilterMarkedEnabled" => set_bool(&mut settings.is_filter_marked_enabled, value),
        "isOnlyMarkedEnabled" => set_bool(&mut settings.is_only_marked_enabled, value),
